...
public class CipherUtils {
    ...
    public static final String ALPHABET_LOWER_NUMERIC_AND_SIGNS = "aàáâãbcçdeéêfghiíjklmnoóôõpqrstuúvwxyz0123456789.,?!/()&:;=-_$@" + '"' + '\'';
    public static final String VOWELS_LOWER = "aàáâãeéêiíjoóôõuú";
    public static final String NUMERIC = "0123456789";
    public static final String NUMERIC_NATURAL = "123456789";
    public static final String NUMERIC_AND_ROMAN = "0123456789IV";
    public static final String MORSE_SIGNS = "-./";
}