...
public class HorizontalCipher extends Cipher {
    ...
    public HorizontalCipher(CipherMessage cipherMessage) {
        super(cipherMessage);
    }
    ...
    public CipherResult encrypt() {
        return new CipherResult(encrypt(getCipherMessage().getMessageAsText(), getCipherMessage().getPasswordAsInt(),"esquerda"));
    }

    @Override
    public CipherResult decrypt() {
        return new CipherResult(decrypt(getCipherMessage().getMessageAsText(), getCipherMessage().getPasswordAsInt(),"esquerda"));
    }
